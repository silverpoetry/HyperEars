...
vivo / iQOO、OPPO Enco、Bose、Edifier、StarRing、ROSESELSA、NiceHCK、水月雨、荣耀、华为、QCY 和 Sony 耳机
...
> ROSESELSA、NiceHCK、水月雨、荣耀、华为、QCY、Sony 及相关品牌无关。
...
| 华为 | FreeBuds Pro 3 实机验证，Pro 4 同构复用；其他标准回退 | FreeBuds Pro 3/4 协议确认后提供私有组件电量；回退设备使用系统整机电量 | FreeBuds Pro 3/4 协议确认后支持降噪、关闭、通透 + 降噪四档与透传两档（类型化扩展） |
