...
| Huawei | FreeBuds Pro 3 hardware-verified, Pro 4 shared-driver; others standard fallback | FreeBuds Pro 3/4 private components after protocol confirmation; Android aggregate on fallback | FreeBuds Pro 3/4: noise cancellation, off and transparency plus four cancellation levels and two transparency levels (typed extension) after protocol confirmation |
